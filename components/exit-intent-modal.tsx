          ...
          <div className="text-center">
            ...
            <div className="my-4">
              <div className="flex items-baseline justify-center gap-2">
                <span className="text-muted-foreground line-through text-lg">R$ 109,90</span>
                <span className="text-3xl font-black text-[#27AE60]">R$ 102,21</span>
              </div>
              <p className="text-xs text-muted-foreground mt-1">ou 12x de R$ 8,52 sem juros</p>
            </div>
          </div>
