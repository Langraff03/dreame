        ...
        <div className="hidden sm:flex items-center gap-4 md:gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <span className="line-through text-muted-foreground text-sm md:text-base font-medium">R$ 499</span>
              <span className="text-[#E53935] font-black text-2xl md:text-3xl">R$ 109,90</span>
