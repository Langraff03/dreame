    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-2xl border-t-4 border-primary/30 py-3 md:py-5 px-3 md:px-6 z-[60] shadow-premium-lg animate-slide-in">
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 md:gap-6 pr-8 sm:pr-0">
        <div className="hidden sm:flex items-center gap-3 md:gap-5">
          <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-primary to-secondary rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
        ...
        >
          ...
          <span className="hidden sm:inline">COMPRAR COM 53% OFF</span>
